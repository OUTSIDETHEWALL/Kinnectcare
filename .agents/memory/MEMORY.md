...
- [Verify bundle identity first](verify-bundle-identity-first.md) — when device behavior contradicts an OTA change, prove embedded-vs-OTA runtime identity before debugging further.
